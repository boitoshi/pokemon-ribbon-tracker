...
> 📦 アーカイブ（2026-03-03 時点の Nuxt→SvelteKit 移行計画。役目を終えた。現行の設計正本は [ui-redesign-plan.md](./ui-redesign-plan.md)）
...
| ✅ 完了 | Phase 6-B: Gen9データ整備 | DLCリボン2本追加（キタカミ・ブルーベリー）、partner-mark削除 |
