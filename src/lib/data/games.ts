...
export const GAMES: Game[] = [
  ...
  // Gen 3 (GBA Switch)
  { id: 'firered_switch', name: 'ポケットモンスター ファイアレッド（Switch）', shortName: 'FR Switch', generation: 3, releaseDate: '2025-01-01', platform: 'Switch' },
  { id: 'leafgreen_switch', name: 'ポケットモンスター リーフグリーン（Switch）', shortName: 'LG Switch', generation: 3, releaseDate: '2025-01-01', platform: 'Switch' },
